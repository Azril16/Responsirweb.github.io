<footer class="ftco-footer ftco-bg-dark ftco-section">
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | CodevSolution <i class="icon-heart" aria-hidden="true"></i> by <a href="#" target="_blank">Hermanto</a>
